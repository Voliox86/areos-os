...
// KAT: inner join + -a1/-a2 unpaired + cartesian product + custom/tab delimiter + differing key
// fields + leading/multiple-blank collapse + multi-field remainder order (all byte-checked vs GNU). 0=pass.
