...
**every program among them** — twenty-three of the twenty-five `.npp`
...
200 sees 2` / `d = 201`), and the other twenty-two match their host
...
closures with their finalisers, the `nwinui` widget dispatch: all of it
