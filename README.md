...
<div align="center">
  ...
  <br/><br/>
  <!-- Badges -->
  <a href="https://github.com/kazah-png/nyx-os/releases/tag/v5.8.11">
    <img src="https://img.shields.io/badge/release-v5.8.11-00ff9d?style=flat" />
  </a>
  <img src="https://img.shields.io/badge/status-v5.8.11-00ff9d?style=flat" />
...
- **19 syscalls** via `syscall`/`sysret`: `exit`, `write`, `print`, `open`, `read`, `close`, `getpid`, `sbrk`, `fsize`, `exec`, `fork`, `waitpid`, `pipe`, `execve`, `dup2`, `getdents`, `kill`, `signal`, `sigreturn`
...
- ✅ 19 syscalls via syscall/sysret (…, dup2, getdents, kill, signal, sigreturn)
