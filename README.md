...
<div align="center">
  ...
  <br/><br/>
  <!-- Badges -->
  <a href="https://github.com/kazah-png/nyx-os/releases/tag/v5.8.6">
    <img src="https://img.shields.io/badge/release-v5.8.6-00ff9d?style=flat" />
  </a>
  <img src="https://img.shields.io/badge/status-v5.8.6-00ff9d?style=flat" />
...
- ✅ `execve()` argv passing: SysV entry stack (`[argc][argv…][NULL]`, crt0 reads `[rsp]`) — programs receive real command-line arguments (verified: `execve("/args.elf", {"args","uno","dos","tres"})` prints all 4 and exits with argc=4) — next: a userspace shell with `a | b`, lazy `sbrk` heap
